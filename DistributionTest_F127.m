% this file reads the low Q and high Q raw data and tries to compare with
% gamma distribution low Q value q = 1.506607E-02 High q value q =
% 2.500345E-01
clc
clear
close all
% this parts load 100 dataset and save the intensity values
