...
I_sim_norm = normrnd(Ilow(1,1),Ilow(1,2),[Data_pts 1]);
...
I_sim_norm_high = normrnd(Ihigh(1,1),Ihigh(1,2),[Data_pts 1]);
...
legend('High Q SANS Data','Simulation from Gamma Dis a = 327 b =0.0017')
set(gca,'FontSize',16,'TickLength',[0.03 0.03],'LineWidth',2);
set(gcf,'Color','w','units','pixels','outerposition',[50 50 600 600]);
...
legend('High Q SANS Data','Fitted Gamma Distribution a = 337 b = 0.0016 ')
set(gca,'FontSize',16,'TickLength',[0.03 0.03],'LineWidth',2);
set(gcf,'Color','w','units','pixels','outerposition',[50 50 600 600]);
%%
figure()
